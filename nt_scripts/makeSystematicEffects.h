...
void makeSystematicEffects(int lid1_, int lid2_, LorentzVector lep1_, LorentzVector lep2_, LorentzVector dilep_, 
			   ...
			   int year, int nsel, double outputVar[15]);
...
void makeSystematicEffects(int lid1_, int lid2_, LorentzVector lep1_, LorentzVector lep2_, LorentzVector dilep_, 
  ...
  double lep1pt,lep2pt,dilmass,dilpt,met,metPhi,trackMet,trackMetPhi,mt,dPhiDiLepMET,dPhiMETTrkMET,pTFrac,mtZ,m2l2j,m2j;
  double llPhi = 0.0;
